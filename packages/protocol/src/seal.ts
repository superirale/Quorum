 ...
 *
 * **Key management** (8110, 38107). A channel key wrapped under the channel key
 * is a locked box containing its own key. The policy is what tells a writer to
 * encrypt, so it must be readable by someone who cannot yet decrypt anything.
 *
...
export const UNSEALED_KINDS: readonly number[] = Object.freeze([
  ...
  8110, // channel_key — the bootstrap
